...
funs &lt;- mget(ls("package:base"), inherits = TRUE) repl\_funs &lt;-
funs\[grepl("^(.\*?)&lt;-$", names(funs))\] ?grepl names(funs)

funs grepl("&lt;-$", names(funs)) head(funs)

require(pryr) find\_funs("package:base", fun\_body, pattern =
"as.data.frame", fixed = TRUE) mem\_used() ?cor
